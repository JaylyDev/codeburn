...
// all execute cleanly under the same stubs. Scope: import purity is proven for
// EVERY exports subpath; call-time purity is proven for these THREE
// representatives only. It is a spot check — a different provider's decoder
// that opens a file when called is still not covered here.
