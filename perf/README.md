...
| Dock/TUI interactions | `--metric dock-tui-proxy` | Badge/overview/view-switch wait path | Capacity Dock hover (native) or TTY TUI keys |
...
Or `npm run perf:all -- --home "$HOME_DIR"`.
